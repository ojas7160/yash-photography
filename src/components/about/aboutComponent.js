	...
	return (
		<div>
			<section
				...
				style={{ backgroundImage: `url(${img38})` }}
			>
			...
			<div className={theme + " about-us-area section-padding-80-0 clearfix"}>
					...
					<div className="row align-items-center">
						<div className="col-12 col-lg-6">
							<div className="about-us-content mb-80">
								...
								<a
									className="btn alime-btn btn-2 mt-30 wow fadeInUp"
			...
			<section className={theme + " why-choose-us-area bg-gray section-padding-80-0 clearfix"}>
				<div className="container">
					<div className="row">
						<div className="col-12">
							<div
			...
			<section className={theme + " our-team-area section-padding-80-50"}>
				<div className="container">
					<div className="row">
						<div className="col-12">
							<div
